    ...
    <div className={classes.listSection}>
      <div className={classes.list}>
        {favourite_event.length > 0 ? (
                  ...
                  <CardActionArea>
                    <CardContent className={classes.cardContent}>
                      <Typography variant="body1">
                        ...
                        Category: {item.category[1].title}
                      </Typography>
                      <Typography variant="body1">
                        <EventIcon className={classes.iconContent} />
                        Event: {item.name[item.language]}
                      </Typography>
                      <Typography variant="body1">
          ...
          <Typography variant="h5">Empty List</Typography>
        )}
      </div>
    </div>
  );
...
export default connect(null, mapDispatchToProps)(FavouriteEvent);
