                ...
                <Card key={props.event.eid} className={classes.card}>
                  ...
                  <CardContent className={classes.cardContent}>
                    <Typography variant="body1">
                      <HomeIcon className={classes.iconContent} /> Location:{" "}
                      {props.event.location[Object.keys(props.event.address)]}
                    </Typography>

                    <Typography variant="body1">
                      <LinkIcon className={classes.iconContent} /> Registration
                      link:{" "}
                      <a
                        href={props.event.enrollment_url}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        {props.event.enrollment_url}
                      </a>
                    </Typography>
                  </CardContent>
                </Card>
